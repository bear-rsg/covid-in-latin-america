    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_time_other', models.CharField(blank=True, help_text="If you only have limited date/time information that doesn't fit into the above fields, please add it here as free text", max_length=1000, null=True, verbose_name='date and time of post (other)')),
